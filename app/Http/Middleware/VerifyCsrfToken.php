...
class VerifyCsrfToken extends Middleware
{
    ...
    protected $except = [
        ...
        ,'/payment-page/test/response','/flakpayregister','/flakpay/logout','/check-email','/flakpay/settlement/get-all-transactions','/flakpay/settlement/file_upload', '/send-mail'
    ];
