...
<body style=" background: #e5ded8;box-sizing: border-box;">
    <div class="blog-container" style=" background: #fff;border-radius: 5px;box-shadow: rgba(0, 0, 0, .2) 0 4px 2px -2px;font-family: adelle-sans, sans-serif;font-weight: 100;margin: 45px auto;">
      ...
      <div class="blog-header">
        <div style="background: #061f5f;background-size: cover;border-radius: 5px 5px 0 0;height: 15rem;box-shadow: inset rgba(0, 0, 0, .2) 0 64px 64px 16px;">
          <div style="margin: 0 auto;padding-top: 0.125rem;width: 80%;">
            <h4 style="color: #fff;font-weight: 800;font-size: 26px; text-align: center;margin-top: 30px;line-height: 21px;">Paylink from {{$htmldata["business_name"]}}</h4>
            <div style="color: #fff;font-weight: 400;text-align: center;margin-top: 30px;line-height: 21px;">
              <p>Paylink id : {{$htmldata["paylink_id"]}}</p>
            <p>{{$htmldata["business_name"]}} has sent you paylink of INR {{number_format($htmldata["amount"],2)}}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style=" margin: 0 auto;width: 80%;">
        ...
        <a href='{{$htmldata["paylink_url"]}}' style="background-color: #178ddb;color: white;padding: 12px;border-radius: 7px;font-family: adelle-sans, sans-serif;cursor: pointer;float: right;font-weight: 600;">Proceed To Pay</a>
      ...
      <div style="margin-left: 30px;">
        <img src="{{asset('new/img/flakpay_logo.png')}}" width="100" alt="Rockpay">
      </div>
    </div>
</body>
</html>
