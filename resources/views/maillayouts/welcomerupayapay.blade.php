        ...
        <div>
          <div style="position: relative;top: 25px; margin:0 auto; width:100%;max-width:598px;text-align:center;background-color:#fff">
                ...
                <tr>
                  ...
                  <td style="background-color:#887aff;text-align:center;width:75px">
                    <div style="width: 130px;">
                      <img style="vertical-align:bottom;width:130px;" src="{{asset('new/img/flakpay_logo.png')}}" alt="Rockpay">
                    </div>
                  </td>
            ...
            <table style="width:100%;max-width:600px;font-family:Arial;font-size:16px;color:#868686;table-layout:fixed;border: 1px solid rgb(167, 167, 167);" cellspacing="0" cellpadding="0" border="0">
             <thead>
               <th colspan="3">
                <p style="text-align:center;width:auto;background-color:#fff;padding: 40px 0;font-size: 28px;font-weight: 550;color: #061f5f;border-bottom: 1px solid rgb(167, 167, 167);margin: 0;">Welcome to Rockpay</p>
                <p style="text-align:center justify;line-height: 26px; width:auto;background-color:#fff;padding: 12px 20px;text-align: justify; font-size: 17px;font-weight: 450;color: rgb(143, 143, 143);margin: 0;">{!! $htmldata["welcomeMessage"] !!}</p>
               </th>
             </thead>
             
              <tbody>
                <tr  style="text-align:center;width:auto;background-color:#fff;padding: 30px 0;font-size: 14px;font-weight: 400;">
                  <td style="padding: 20px 0;border-bottom: 1px solid #ccc;" colspan="3"><p style="text-align: start;padding: 0 13px;line-height: 29px;">If you have any queries concerning the processing of your online payment, please contact our support, <span style="color: #178ddb;"><a href="mailto:support@Rockpay.in"></a>support@Flakpay.in</span></p></td>
                </tr>
                <tr>
                  <td colspan="1"><div class="row">
                    <div style="float: left; width: 100%;">
                      <p style="font-weight: 400;font-size: 13px;padding-left: 8px;line-height: 22px;">Flakpay
                        <br><a href="mailto:hello@Rockpay.in">hello@Flakpay.in</a>
                        <br><a href="tel:+91 9898989898">+91 9898989898</a>
                      </p>
                    </div>
                  </div></td>
                  <td colspan="2">
                    <div style="float: right;padding: 5px 8px 5px 0;">
                      <a href="https://Rockpay.qrcsolutionz.com/" target="_blank"><img src="{{asset('/images/rupayapay-pci.png')}}" alt="Rockpay-pci" width="70"></a>
            ...
            <p style="text-align:center justify; width:auto;background-color:#fff;padding: 12px 20px;font-size: 15px;font-weight: 400;color: rgb(143, 143, 143);">&copy; Copyright Designed By <span style="color: #178ddb;text-decoration: underline;"></span></p>
          </div>
        </div>
