          ...
          <div style="margin:0 auto;width:100%;max-width:598px;text-align:center;background-color:#061f5f">
                ...
                <tr>
                  ...
                  <td style="background-color:#efefeb;text-align:center;width:75px">
                    <div style=" background: #cceefa;width: 100px;height: 100px;border-radius: 50%;position: relative;top: 50px;">
                      <img style="vertical-align:bottom;width:100px;min-height:38px;margin-top: 8px;" src="{{asset('assets/img/flakpay_logo.png')}}">
                    </div>
                  </td>
            ...
            <div style="font-size:0;background-color:#061f5f;height: auto;">
              ...
              <div style="display:inline-block;width:70%;vertical-align:top;color:#f7f7f7;text-align:center">
                ...
                <div style="font-size:29px;font-weight:bold;padding-bottom:12px;padding-top:25px;color: rgb(212, 211, 211);">Reset Password</div>
                <hr style="width:80%;border:1px solid #2f6577">
                <div style="font-size:18px;font-weight:550;padding-top:12px;padding-bottom:6px;color: rgb(212, 211, 211);">Hi {{$htmldata['employee_name']}}, <br> You have received this mail as you requested to reset your password <br> Below is your one time passcode</div>
