...
$(document).ready(function() {
    ...
    $('#selct_dropdowns').on('change', function() {
        ...
        if (selectedValue !== 'select') {
            $.ajax({
                url: '/flakpay/payout_get_transactions',
                type: 'GET',
...
<script>
    $(document).on('click', '.transactiongid', function() {
        ...
        $.ajax({
            ...
            type: "GET",
            dataType: "json",
            url: '/flakpay/payout_transaction_info',
            data: {
...
<script>
    $(document).on('click', '.callinfo', function() {
        ...
        $.ajax({
            ...
            type: "GET",
            dataType: "json",
            url: '/flakpay/technical/findvendortransactionstatus',
            data: {
...
<script>
    $(document).on('click', '.updatestatus', function() {
        ...
        $.ajax({
            ...
            type: "GET",
            dataType: "json",
            url: '/flakpay/update_payout_transaction_status',
            data: {
                'transactionid': orderid
            },
            success: function(data) {
        ...
        dataTable.search('').columns().search('').draw();
                ...
                $.ajax({
                    ...
                    type: "GET",
                    dataType: "json",
                    url: '/rockpay/payout_get_transactions',
                    data: {
                        // 'status':satus_select,
                        'search': search,
                        'startdate': startDate,
